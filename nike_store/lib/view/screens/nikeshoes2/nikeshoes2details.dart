...
import 'package:nike_store/view/widgets/orderNowSheet.dart';
import '../../../model/shoesProduct.dart';
import 'package:nike_store/view/widgets/shakeTransition.dart';
              ...
              Center(child: GestureDetector(
                ...
                child: Container(
                  decoration: BoxDecoration(
                    gradient: LinearGradient(colors: [Colors.black,shoesItem[widget.index].col]),
...
class _bottombarState extends State<_bottombar> {
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        Text(shoesItem[widget.index].model,style: constants().bigFontStyle,),
        Row(
          children: [
            ...List.generate(5, (index) {
              if(index==4)
              {
                ...
                child: Icon(Icons.star,color: Color.fromARGB(255, 255, 255, 255),),
              );
              }
              return Padding(
                padding: const EdgeInsets.all(8.0),
                child: Icon(Icons.star,color: Color.fromARGB(255, 215, 255, 72),),
              );
            } )
          ],
        ),
              ...
              return Padding(
                ...
                child: InkWell(
                  ...
                  child: Container(
                    ...
                    color:index==curridx?Colors.blue: Colors.white,
